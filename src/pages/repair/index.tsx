...
const RepairTemplate: React.FC = () => {
  const [isOpenContactModal, setIsOpenContactModal] = useState(false);
  const pageContext = Brands["page-templates"];
  const householdBrands = pageContext.filter((brand: any) =>
    brand.title.includes("бытовых")
  );
  const builtInBrands = pageContext.filter((brand: any) =>
  ...
  return (
    <LayoutWrapper
      title="Ремонт и обслуживание кофемашин в Минске, настройка и чистка | Koferem "
