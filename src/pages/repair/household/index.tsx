...
const builtInNavigation = [
  {
    title: "Ремонт Neff",
    link: "/repair/built-in?brand=neff",
  },
  {
    title: "Ремонт Miele",
    link: "/repair/built-in?brand=miele",
  },
  {
    title: "Ремонт Gaggenau",
    link: "/repair/built-in?brand=gaggenau",
  },
  {
    title: "Ремонт Kuppersbusch",
    link: "/repair/built-in?brand=kupperbusch",
  },
  {
    title: "Ремонт AEG",
    link: "/repair/built-in?brand=aeg",
  },
  {
    title: "Ремонт Bosch",
    link: "/repair/built-in?brand=bosch",
  },
  {
    title: "Ремонт Electrolux",
    link: "/repair/built-in?brand=electrolux",
  },
  {
    title: "Ремонт Gorenje",
    link: "/repair/built-in?brand=gorenje",
  },
  {
    title: "Ремонт Hotpoint-Ariston",
    link: "/repair/built-in?brand=hotpoint-ariston",
  },
  {
    title: "Ремонт Siemens",
    link: "/repair/built-in?brand=siemens",
  },
  {
    title: "Ремонт Kaiser",
    link: "/repair/built-in?brand=kaiser",
  },
  {
    title: "Ремонт Asko",
    link: "/repair/built-in?brand=asko",
  },
  {
    title: "Ремонт Fulgor",
    link: "/repair/built-in?brand=fulgor",
  },
  {
    title: "Ремонт Graude",
    link: "/repair/built-in?brand=graude",
  },
  {
    title: "Ремонт Smeg",
    link: "/repair/built-in?brand=smeg",
  },
  {
    title: "Ремонт Teka",
    link: "/repair/built-in?brand=teka",
  },
];

const householdNavigation = [
  { title: "Ремонт Bosch", link: "/repair/household?brand=bosch" },
  { title: "Ремонт Miele", link: "/repair/household?brand=miele" },
  {
    title: "Ремонт Panasonic",
    link: "/repair/household?brand=panasonic",
  },
  {
    title: "Ремонт Schaerer",
    link: "/repair/household?brand=schaerer",
  },
  {
    title: "Ремонт WMF",
    link: "/repair/household?brand=wmf",
  },
  {
    title: "Ремонт Franke",
    link: "/repair/household?brand=franke",
  },
  {
    title: "Ремонт Gastrorag",
    link: "/repair/household?brand=gastrorag",
  },
  {
    title: "Ремонт Grand Rich",
    link: "/repair/household?brand=grand-rich",
  },
  {
    title: "Ремонт Kambrook",
    link: "/repair/household?brand=kambrook",
  },
  {
    title: "Ремонт Merol",
    link: "/repair/household?brand=merol",
  },
  {
    title: "Ремонт Nivona",
    link: "/repair/household?brand=nivona",
  },
  { title: "Ремонт Delonghi", link: "/repair/household?brand=delonghi" },
  {
    title: "Ремонт Saeco",
    link: "/repair/household?brand=saeco",
  },
  {
    title: "Ремонт Siemens",
    link: "/repair/household?brand=siemens",
  },
  {
    title: "Ремонт Krups",
    link: "/repair/household?brand=krups",
  },
  {
    title: "Ремонт Jura",
    link: "/repair/household?brand=jura",
  },
  {
    title: "Ремонт Philips",
    link: "/repair/household?brand=philips",
  },
  {
    title: "Ремонт Melitta",
    link: "/repair/household?brand=melitta",
  },
];
...
const HouseholdBrandTemplate: React.FC = () => {
  ...
  const currentBrand = Brands["page-templates"].find(
    (brandItem: any) => brandItem.path === `household?brand=${brand}`
  );
