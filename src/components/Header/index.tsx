        ...
        <div className="bg-[#2c2c2c80] bg-opacity-50 py-3 ">
          <div className="max-w-6xl mx-5 md:mx-auto flex justify-between">
            <div className="flex items-center space-x-3">
              ...
              <FaBirthdayCake className="text-[20px] text-[#c9a246] hidden md:block" />
              <p className="hidden md:block">Нам исполнилось 12 лет!</p>
            </div>

            <div className="flex items-center space-x-5">
              <a
                className="text-white items-center space-x-3 hover:text-[#c9a246] hidden md:flex"
              ...
              <a
                className="text-white flex items-center space-x-3 hover:text-[#c9a246] hidden md:flex"
